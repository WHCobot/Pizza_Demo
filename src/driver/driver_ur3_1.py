...
pub_joint_states = rospy.Publisher('ur3_1/joint_states', JointState, queue_size=1)
pub_wrench = rospy.Publisher('ur3_1/wrench', WrenchStamped, queue_size=1)
pub_io_states = rospy.Publisher('ur3_1/io_states', IOStates, queue_size=1)
...
class URTrajectoryFollower(object):
    ...
    def __init__(self, robot, goal_time_tolerance=None):
        ...
        self.T0 = time.time()
        self.robot = robot
        self.server = actionlib.ActionServer("follow_joint_trajectory_ur3_1",
